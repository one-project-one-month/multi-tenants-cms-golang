...
func (q *Queries) DeleteAssociatedLessons(ctx context.Context, moduleID pgtype.UUID) error {
...
func (q *Queries) DeleteAssociatedQuizzes(ctx context.Context, moduleID pgtype.UUID) error {
...
func (q *Queries) DeleteModule(ctx context.Context, moduleID pgtype.UUID) error {
...
func (q *Queries) DeleteModules(ctx context.Context, dollar_1 []pgtype.UUID) error {
...
func (q *Queries) GetModuleByID(ctx context.Context, moduleID pgtype.UUID) (Module, error) {
...
func (q *Queries) ModuleHasAssociations(ctx context.Context, moduleID pgtype.UUID) (pgtype.Bool, error) {
