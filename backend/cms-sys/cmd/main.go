...
func dependencyInjectionSection(
	...
	serviceCommunication := file_srv_communication.NewFileClient("http://localhost:9009", time.Second*40)
	...
	pageRequestHandler := handler.NewPageRequestHandler(pageRequestSrv, s3, serviceCommunication)
