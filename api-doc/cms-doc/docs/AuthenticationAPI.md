...
------------- | ------------- | -------------
[**AuthLoginPost**](AuthenticationAPI.md#AuthLoginPost) | **Post** /auth/login | User login with MFA
...
> AuthResponse AuthLoginPost(ctx).MFALoginRequest(mFALoginRequest).Execute()
...
func main() {
	mFALoginRequest := *openapiclient.NewMFALoginRequest("Email_example", "Password_example", "MfaCode_example") // MFALoginRequest | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AuthenticationAPI.AuthLoginPost(context.Background()).MFALoginRequest(mFALoginRequest).Execute()
	if err != nil {
...
------------- | ------------- | ------------- | -------------
 **mFALoginRequest** | [**MFALoginRequest**](MFALoginRequest.md) |  | 
